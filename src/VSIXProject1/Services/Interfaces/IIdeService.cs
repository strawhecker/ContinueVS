...
namespace ContinueVS.Services.Interfaces
{
    ...
    public interface IIdeService
    {
        ...
        // Debug Operations
        /// <summary>
        /// Inspects the current runtime state during debugging (locals, callstack, watches).
        /// </summary>
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>Current RuntimeState or null if debugger not active.</returns>
        Task<RuntimeState?> InspectVariablesAsync(CancellationToken cancellationToken = default);
        ...
        Task<RuntimeState?> StepAsync(DebugStepAction action, CancellationToken cancellationToken = default);

        /// <summary>
        /// Resumes execution after a breakpoint. Enforces 30-second timeout.
        /// </summary>
