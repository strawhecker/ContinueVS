...
namespace ContinueVS.Tests.UI
{
    ...
    /// 
    /// All tests are wrapped with StaTestHelper.RunAsync() because CoreWebView2Environment.CreateAsync()
    /// requires STA context (thread affinity for COM interop). xUnit runs tests on MTA by default.
    /// </summary>
