...
# Scan Files - Dependency DAG (Bottom-Up / Post-Order DFS - CORRECTED & VALIDATED)

**Status**: ✅ VALIDATED against actual filesystem  
**Entry Point**: `reference/continue-src/gui/index.html`  
**Root appears**: LAST in list  
**Corrections Applied**: (1) useWebviewListener.tsx → .ts (2) OnboardingCard → OnboardingCard/OnboardingCard.tsx (3) TipTapEditor → TipTapEditor/TipTapEditor.tsx

| File | Exists | Deps From | Notes |
|------|--------|-----------|-------|
| reference/continue-src/gui/src/vite-env.d.ts | ✓ | (Vite types) | TypeScript Vite env definitions |
| reference/continue-src/gui/src/index.css | ✓ | (external) | Global stylesheet |
| reference/continue-src/core/protocol/util.ts | ✓ | reference/continue-src/core | Protocol utilities |
| reference/continue-src/core/protocol/messenger/index.ts | ✓ | reference/continue-src/core/protocol | Message handler base |
| reference/continue-src/core/protocol/messenger/messageIde.ts | ✓ | reference/continue-src/core/protocol | IDE message implementation |
| reference/continue-src/core/protocol/messenger/reverseMessageIde.ts | ✓ | reference/continue-src/core/protocol | Reverse IDE message |
| reference/continue-src/core/llm/constants.ts | ✓ | reference/continue-src/core | LLM config constants |
| reference/continue-src/core/tools/builtIn.ts | ✓ | reference/continue-src/core | Built-in tool definitions |
| reference/continue-src/gui/src/util/cn.ts | ✓ | (classnames) | CSS class utility |
| reference/continue-src/gui/src/util/isContinueTeamMember.ts | ✓ | (local check) | Team member check |
| reference/continue-src/gui/src/util/localStorage.ts | ✓ | (window.localStorage) | Local storage helpers |
| reference/continue-src/gui/src/util/navigation.ts | ✓ | (constants) | Route constants |
| reference/continue-src/gui/src/util/compactConversation.ts | ✓ | core | Conversation compaction |
| reference/continue-src/gui/src/util/editOutcomeLogger.ts | ✓ | core | Edit logging |
| reference/continue-src/gui/src/util/errorAnalysis.ts | ✓ | core | Error analysis |
| reference/continue-src/gui/src/util/index.ts | ✓ | (utils) | Utilities index |
| reference/continue-src/gui/src/util/migrateLocalStorage.ts | ✓ | (storage) | Storage migration |
| reference/continue-src/gui/src/util/toolCallState.ts | ✓ | redux | Tool call state utils |
| reference/continue-src/gui/src/util/clientTools/editImpl.ts | ✓ | core | Edit implementation |
| reference/continue-src/gui/src/util/clientTools/multiEditImpl.ts | ✓ | core | Multi-edit implementation |
| reference/continue-src/gui/src/util/clientTools/singleFindAndReplaceImpl.ts | ✓ | core | Single find/replace |
| reference/continue-src/gui/src/util/clientTools/callClientTool.ts | ✓ | core | Client tool caller |
| reference/continue-src/gui/src/util/test/config.ts | ✓ | (test config) | Test utilities |
| reference/continue-src/gui/src/util/test/mockStore.ts | ✓ | redux | Mock Redux store |
| reference/continue-src/gui/src/util/test/setupTests.ts | ✓ | (test setup) | Test setup |
| reference/continue-src/gui/src/util/test/utils.ts | ✓ | (test utils) | Test utilities |
| reference/continue-src/gui/src/util/test/render.tsx | ✓ | react, redux | React test render |
| reference/continue-src/gui/src/context/Auth.tsx | ✓ | react, IdeMessenger | Auth context |
| reference/continue-src/gui/src/context/LocalStorage.tsx | ✓ | react, localStorage | Storage context |
| reference/continue-src/gui/src/context/VscTheme.tsx | ✓ | react | Theme context |
| reference/continue-src/gui/src/context/SubmenuContextProviders.tsx | ✓ | react | Submenu context |
| reference/continue-src/gui/src/context/IdeMessenger.tsx | ✓ | core/protocol, core/protocol/messenger, UUID, utils | IDE messenger (277 lines) |
| reference/continue-src/gui/src/components/OnboardingCard/OnboardingCard.tsx | ✓ | react, core | Onboarding UI |
| reference/continue-src/gui/src/components/OSRContextMenu.tsx | ✓ | react | Context menu |
| reference/continue-src/gui/src/components/config/FatalErrorNotice.tsx | ✓ | styled-components, redux | Fatal error display |
| reference/continue-src/gui/src/components/dialogs/index.tsx | ✓ | react | Dialog components |
| reference/continue-src/gui/src/components/mainInput/TipTapEditor/TipTapEditor.tsx | ✓ | react, @tiptap | Rich text editor |
| reference/continue-src/gui/src/hooks/useWebviewListener.ts | ✓ | react, IdeMessenger | Webview listener hook |
| reference/continue-src/gui/src/hooks/ParallelListeners.tsx | ✓ | react, IdeMessenger | Parallel listeners hook |
| reference/continue-src/gui/src/redux/hooks.ts | ✓ | @reduxjs/toolkit, react-redux | Redux hooks |
| reference/continue-src/gui/src/redux/util/index.ts | ✓ | redux | Redux utilities |
| reference/continue-src/gui/src/redux/util/getBaseSystemMessage.ts | ✓ | redux/util, core | System message |
| reference/continue-src/gui/src/redux/util/constructMessages.ts | ✓ | redux/util, core | Construct messages |
| reference/continue-src/gui/src/redux/selectors/index.ts | ✓ | redux/store | Redux selectors |
| reference/continue-src/gui/src/redux/selectors/selectActiveTools.ts | ✓ | redux/store | Select active tools |
| reference/continue-src/gui/src/redux/selectors/selectToolCalls.ts | ✓ | redux/store | Select tool calls |
| reference/continue-src/gui/src/redux/thunks/callToolById.ts | ✓ | redux/store, core | Tool invocation |
| reference/continue-src/gui/src/redux/thunks/preprocessToolCallArgs.ts | ✓ | redux/store | Preprocess tool args |
| reference/continue-src/gui/src/redux/thunks/evaluateToolPolicies.ts | ✓ | redux/store, core | Evaluate policies |
| reference/continue-src/gui/src/redux/thunks/cancelStream.ts | ✓ | redux/store | Cancel stream |
| reference/continue-src/gui/src/redux/thunks/cancelToolCall.ts | ✓ | redux/store | Cancel tool call |
| reference/continue-src/gui/src/redux/thunks/streamNormalInput.ts | ✓ | redux/store, sessionSlice | Stream normal input |
| reference/continue-src/gui/src/redux/thunks/streamResponseAfterToolCall.ts | ✓ | redux/store, sessionSlice | Stream after tool |
| reference/continue-src/gui/src/redux/thunks/handleApplyStateUpdate.ts | ✓ | redux/store, sessionSlice | Handle apply state |
| reference/continue-src/gui/src/redux/thunks/moveTerminalProcessToBackground.ts | ✓ | redux/store | Move terminal process |
| reference/continue-src/gui/src/redux/thunks/updateFileSymbols.ts | ✓ | redux/store | Update file symbols |
| reference/continue-src/gui/src/redux/thunks/updateSelectedModelByRole.ts | ✓ | redux/store | Update model |
| reference/continue-src/gui/src/redux/thunks/streamThunkWrapper.tsx | ✓ | redux/store | Stream thunk wrapper |
| reference/continue-src/gui/src/redux/thunks/streamResponse.ts | ✓ | redux/store, sessionSlice, core | Stream response (644 lines) |
| reference/continue-src/gui/src/redux/thunks/edit.ts | ✓ | redux/store, sessionSlice, editState | Edit mode thunks |
| reference/continue-src/gui/src/redux/thunks/session.ts | ✓ | redux/store, sessionSlice | Session thunks |
| reference/continue-src/gui/src/redux/slices/editState.ts | ✓ | @reduxjs/toolkit, core | Edit state reducer |
| reference/continue-src/gui/src/redux/slices/indexingSlice.ts | ✓ | @reduxjs/toolkit, core | Indexing state |
| reference/continue-src/gui/src/redux/slices/profilesSlice.ts | ✓ | @reduxjs/toolkit, core | Profiles state |
| reference/continue-src/gui/src/redux/slices/tabsSlice.ts | ✓ | @reduxjs/toolkit | Tabs state |
| reference/continue-src/gui/src/redux/slices/sessionSlice.ts | ✓ | @reduxjs/toolkit, core, uuid, thunks | Session state (1097 lines) |
| reference/continue-src/gui/src/redux/slices/configSlice.ts | ✓ | @reduxjs/toolkit, @continuedev/config-yaml, core | Config state (109 lines) |
| reference/continue-src/gui/src/redux/slices/uiSlice.ts | ✓ | @reduxjs/toolkit, core, builtIn, OnboardingCard, localStorage | UI state (171 lines) |
| reference/continue-src/gui/src/styles/theme.ts | ✓ | styled-components | Theme definitions |
| reference/continue-src/gui/src/styles/utils.ts | ✓ | styled-components | Style utilities |
| reference/continue-src/gui/src/styles/ThemePage.tsx | ✓ | react, styled-components | Theme page |
| reference/continue-src/gui/src/pages/error.tsx | ✓ | react | Error page |
| reference/continue-src/gui/src/pages/stats.tsx | ✓ | react, redux | Stats page |
| reference/continue-src/gui/src/pages/history/index.tsx | ✓ | react, redux, core | History page |
| reference/continue-src/gui/src/pages/config/index.tsx | ✓ | react, redux, core | Config page |
| reference/continue-src/gui/src/pages/gui/EmptyChatBody.tsx | ✓ | react | Empty chat UI |
| reference/continue-src/gui/src/pages/gui/ExploreDialogWatcher.tsx | ✓ | react, redux | Explore dialog |
| reference/continue-src/gui/src/pages/gui/StreamError.tsx | ✓ | react, redux | Stream error display |
| reference/continue-src/gui/src/pages/gui/useAutoScroll.ts | ✓ | react | Auto scroll hook |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/ToolCallArgs.tsx | ✓ | react, core | Tool call args |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/ToolCallDisplay.tsx | ✓ | react, styled-components | Tool call display |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/ToolCallStatusMessage.tsx | ✓ | react | Status message |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/ToolTruncateHistoryIcon.tsx | ✓ | react | Truncate icon |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/ToggleWithIcon.tsx | ✓ | react | Toggle icon |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/IndicatorBar.tsx | ✓ | react, styled-components | Indicator bar |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/TerminalCollapsibleContainer.tsx | ✓ | react, styled-components | Terminal container |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/CreateFile.tsx | ✓ | react, core | Create file UI |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/EditFile.tsx | ✓ | react, core | Edit file UI |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/FindAndReplace.tsx | ✓ | react, core | Find/replace UI |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/RunTerminalCommand.tsx | ✓ | react, core | Terminal command UI |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/MCPAppRenderer.tsx | ✓ | react | MCP app render |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/SimpleToolCallUI.tsx | ✓ | react | Simple tool UI |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/GroupedToolCallHeader.tsx | ✓ | react | Tool header |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/FunctionSpecificToolCallDiv.tsx | ✓ | react, core | Function-specific UI |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/utils.tsx | ✓ | core, redux | Tool call utils |
| reference/continue-src/gui/src/pages/gui/ToolCallDiv/index.tsx | ✓ | react, core, redux | Tool call render |
| reference/continue-src/gui/src/pages/gui/Chat.tsx | ✓ | react, redux, core, IdeMessenger | Chat page (main) |
| reference/continue-src/gui/src/pages/gui/index.tsx | ✓ | react, redux, core, pages/gui/* | GUI page wrapper |
| reference/continue-src/gui/src/redux/store.ts | ✓ | @reduxjs/toolkit, redux-persist, IdeMessenger, all-slices | Redux store (153 lines) |
| reference/continue-src/gui/src/components/Layout.tsx | ✓ | react, react-router-dom, core, Auth, IdeMessenger, LocalStorage, hooks, redux, thunks, pages, dialogs | Layout wrapper (234 lines) |
| reference/continue-src/gui/src/App.tsx | ✓ | react-router-dom, Layout, TipTapEditor, contexts, ParallelListeners, pages, styles, util | Root React app (66 lines) |
| reference/continue-src/gui/src/main.tsx | ✓ | react, react-dom, react-redux, redux-persist, App, store, index.css | Entry point (24 lines) |
| reference/continue-src/gui/index.html | ✓ | src/main.tsx (module) | HTML root - **ROOT OF DAG** |
