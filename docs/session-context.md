...
| c17-rev | 3: E2E Visual Test | **Validation** | **GUI Visual Test: Tools Dropdown** — Open ContinueVS. In chat input, check if tool dropdown appears with 3 items (from c15 mock data). Expand and count them visually. | c16.3 | Screenshot of GUI with tool dropdown open, showing 3 items. All items visible and clickable. |
